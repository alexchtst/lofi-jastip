    ...
    <div className="w-full h-screen flex justify-center items-center p-6">
      <div className="bg-white w-full p-5 rounded-md space-y-5 shadow-[8px_8px_39px_7px_rgba(0,0,0,0.1)] border border-gray-200">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="text-sm text-center text-white p-2 rounded-md bg-black" onClick={() => usenavigate('/courier/dashboard')}>Masuk</div>
        </div>
        ...
        <div className="flex flex-col gap-1">
          <div className="text-white w-full flex items-center justify-center gap-3 bg-blue-600 p-2 rounded-md" onClick={() => usenavigate('/courier/dashboard')}>
            <Facebook />
            <label>Facebook</label>
          </div>
          <div className="text-white w-full flex items-center justify-center gap-3 bg-red-600 p-2 rounded-md" onClick={() => usenavigate('/courier/dashboard')}>
            <Chrome />
            <label>Google</label>
          </div>
        </div>
